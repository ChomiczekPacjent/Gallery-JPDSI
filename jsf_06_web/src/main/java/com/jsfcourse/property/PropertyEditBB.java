...
public class PropertyEditBB implements Serializable {
    ...
    public String saveData() {
        try {
            if (property == null) {
                context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Brak danych.", null));
         ...
         // Walidacja wymaganych pól
            ...
            if (property.getIdProperty() == null) {
                ...
                context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Sztuka została dodana.", null));
            } else {
                // Aktualizacja istniejącej
                propertyDAO.merge(property);
                context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Sztuka została zaktualizowana.", null));
            }
            ...
            if (uploadedImage != null && uploadedImage.getSize() > 0) {
                try {
                    ...
                    String uploadDir = "C:/MAGAZYN/Programowanie/eclipse_workspaces/jee2-2409R/jsf_06_web/src/main/webapp/uploads";
                    ...
                    // Druga lokalizacja
                   String uploadDir2 = "C:\\MAGAZYN\\Serwery\\wildfly-33.0.2.Final\\standalone\\deployments\\jsf_06_EAR.ear\\jsf_06_web.war\\uploads";
